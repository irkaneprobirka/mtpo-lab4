...
\newcommand{\keywordsRu}{автоматизация тестирования, модульное тестирование, JavaScript, Jest, Vitest, Mocha, Node.js, ОЗУ, CPU} % ВВЕДИТЕ ключевые слова по-русски
\newcommand{\abstractRu}{В работе выполнен сравнительный анализ фреймворков модульного тестирования JavaScript: Jest, Vitest и Mocha на задаче тестирования алгоритма Манакера. Разработано программное средство на Node.js для импорта JSON, проверки эталонного результата, запуска 99 одинаковых тестов и измерения времени выполнения, пиковой оперативной памяти и накопленного CPU-времени и средней CPU-загрузки. Приведены математическая постановка, псевдокод, пошаговый пример, результаты эксперимента и практические рекомендации.}
%
