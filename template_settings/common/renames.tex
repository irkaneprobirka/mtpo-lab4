...
\newcommand{\keywordsRu}{автоматизация тестирования, модульное тестирование, JavaScript, Jest, Vitest, Mocha, Node.js, производительность, ОЗУ, CPU} % ВВЕДИТЕ ключевые слова по-русски
\newcommand{\abstractRu}{В работе рассматривается сравнительный анализ фреймворков модульного тестирования JavaScript: Jest, Vitest и Mocha. Описана математическая постановка задачи сравнения по времени выполнения, пиковому потреблению оперативной памяти и пиковой загрузке CPU. Разработано компактное программное средство на Node.js с импортом входных данных из JSON, эталонным примером и инструкцией запуска. Приведены псевдокод алгоритма измерения, пошаговый иллюстративный пример и рекомендации по выбору фреймворка в зависимости от контекста проекта.}
%

\newcommand{\PracticeType}{Отчет о выполнении практической работы}
\newcommand{\School}{Высшая школа программной инженерии}
\newcommand{\practiceTitle}{Сравнительный анализ фреймворков модульного тестирования для JavaScript: Jest, Vitest и Mocha}
