...
\newcommand{\abstractRu}{В работе выполнен сравнительный анализ фреймворков модульного тестирования JavaScript: Jest, Vitest и Mocha на задаче тестирования алгоритма Манакера. Разработано программное средство на Node.js для импорта JSON и CSV, проверки эталонного результата, запуска одинаковых тестов и измерения времени выполнения, пиковой оперативной памяти и пиковой загрузки CPU. Приведены математическая постановка, псевдокод, пошаговый пример, результаты эксперимента и практические рекомендации.}
%
