...
\newcommand{\abstractRu}{В работе выполнен сравнительный анализ фреймворков модульного тестирования JavaScript: Jest, Vitest и Mocha. Разработано программное средство на Node.js для запуска одинаковых модульных тестов, импорта JSON и CSV, проверки эталонного результата и измерения времени выполнения, пиковой оперативной памяти и пиковой загрузки CPU. Приведены математическая постановка, псевдокод алгоритма измерения, пошаговый пример, результаты эксперимента и практические рекомендации.}
%
